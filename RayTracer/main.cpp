...
int main(int argc, char* argv[]) {
    ...
    while (running) {
        ...
        if (renderWingedEdge) {
            RenderWingedEdgeWireframe(renderer, meshCollection, camera, destination_rect, WEimguiInterface, font, renderWingedEdgeArrows, renderWingedEdgeText);
        }
